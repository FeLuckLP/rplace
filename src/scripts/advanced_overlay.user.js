...
if( window.top !== window.self ) {
	addEventListener( "load", () => {
		// ==============================================
		const STORAGE_KEY = "place-gronkh-2023-ostate";
		const OVERLAYS = [
			[ "https://raw.githubusercontent.com/FeLuckLP/rplace/main/overlay.png", "kleine Pixel" ],
			[ "https://raw.githubusercontent.com/FeLuckLP/rplace/main/output.png", "große Pixel" ]/*,
      ["https://raw.githubusercontent.com/FeLuckLP/rplace/main/overlay.png", "Gronkh (kleine Pixel)"],
      ["https://raw.githubusercontent.com/FeLuckLP/rplace/main/overlay.png", "Gronkh (große Pixel)"],
      ["https://raw.githubusercontent.com/rplacebonjwa/rplace/main/overlay.png", "Bonjwa (kleine Pixel)"],
      ["https://raw.githubusercontent.com/rplacebonjwa/rplace/main/overlay.png", "Bonjwa (große Pixel)"],
      ["https://place.army/overlay_target.png", "placeDE (kleine Pixel)"],
      ["https://place.army/default_target.png", "placeDE (große Pixel)"]*/
		];
		...
		img.onload = () => {
			console.log( "[GronkhOverlay] img loaded" );
			img.style.opacity = oState.opacity / 100;
		};

		const updateImage = () => {
			img.src = getConfig( OVERLAYS[ oState.overlayIdx ][ 0 ] );
			console.log( "[GronkhOverlay] updated overlay image" );
		};
